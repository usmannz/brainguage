...
export class QuizService {
    ...
    generateUserQuiz(userId): Observable<any> {
        return this._http.get<any>(`${Settings.apiBase}quiz/GenerateQuiz/${userId}`);
    }

    saveQuizResponse(ans: any): Observable<number> {
        return this._http.post<number>(`${Settings.apiBase}quiz/saveQuizResponse`, ans)
    }
