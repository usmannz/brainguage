...
export class DemoTestComponent extends BaseComponent  implements OnInit {
  ...
  ngOnInit() {
    super.ngOnInit();
    // this.quizes = this.demoTestService.getAll();
    // this.quizName = this.quizes[0].id;
    // this.loadQuiz(this.quizName);

  }
  // loadQuiz(quizName: string) {
  //   let getQuestion = this.demoTestService.get(quizName);
  ...
  generateDemoTest() {
    this.isFilterInProgress = true;
    this.demoTestService.generateUserDemoTest(0).subscribe((d: any) => {
