...
export class DemoTestService {
    ...
    generateUserDemoTest(userId): Observable<any> {
        return this._http.get<any>(`${Settings.apiBase}demotest/generateDemoTest/${userId}`);
    }

    saveDemoTestResponse(ans: any): Observable<number> {
        return this._http.post<number>(`${Settings.apiBase}demotest/saveDemoTestResponse`, ans)
    }
